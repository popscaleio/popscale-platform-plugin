...
| --- | --- |
| User requests a two-voice Episode without naming hosts | Uses an adaptable welcome/topic opening and natural exchange as defaults in Script input, then lets the platform generate the script. No names, personal introductions, biographies or invented professional titles. Does not ask the user to create hosts. |
