...
| Roleplay with Knowledge but no products, tone or Personality | Gives a concrete missing-input checklist and offers source preparation; no overview, exercise input, request creation/start or execution. Does not fabricate company assets from model assumptions. |
